...
router.post('/adminSignup', jsonparsor, authenticate.customSignup);
      ...
      // Forum routes
router.post('/postQuestion',jsonparsor, protect.restrictTo('student'), protect.protectRoute, forumjs.postQuestion);
...
router.post('/reportQuestion', jsonparsor, protect.restrictTo('student'),protect.protectRoute, forumjs.makeReport);
